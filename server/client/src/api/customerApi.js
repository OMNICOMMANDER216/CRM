...
const token  = getToken();
 ...
 const api = {
    ...
    updateCustomerAssign: (customer) => axios.put('/api/customers/assign', {method: 'PUT', data: customer, headers: { 'Content-Type': 'application/json','Access-Control-Allow-Methods' : '*' }, mode: 'cors' }).then(res => res.data)
};
