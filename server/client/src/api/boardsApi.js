...
const boardsApi = {
            ...
            updateBoardAssign: (board) => axios.put('/api/boards/assign', {method: 'PUT', data: board, headers: { 'Content-Type': 'application/json','Access-Control-Allow-Methods' : '*' }, mode: 'cors' }).then(res => res.data)
};
