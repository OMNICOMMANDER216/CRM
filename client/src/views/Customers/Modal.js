...
import {
  Button, Col, Form, FormGroup, FormText, Input, Label, Modal, ModalHeader, ModalBody, ModalFooter,
} from 'reactstrap';

export default ({
  modalNote, closeModal, openModal, noteHandler, saveNote, errors,
}) => (
  <React.Fragment>
    <Button color="danger" className="FloatingBtn" onClick={openModal}><i className="fa fa-plus" /></Button>
