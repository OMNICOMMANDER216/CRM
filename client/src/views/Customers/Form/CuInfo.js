            ...
            <FormGroup row>
              ...
              <Col xs="12" md="9">
                <Input 
                  ...
                  id="url" 
                  name="url" 
                  placeholder="ie: www.example.com" 
                  onChange={onChange} 
                  value={customer.url}/>
            ...
            <FormGroup row>
              ...
              <Col xs="12" md="9">
                <Input 
                  type="date" 
                  id="finalChangesDate" 
                  name="finalChangesDate" 
                  placeholder="date" 
                  onChange={onChange} 
                  value={customer.finalChangesDate}/>
              </Col>
            </FormGroup>
            <FormGroup row>
              <Col md="3">
